...
# mark_description "";
# mark_description "-S -finline-limit=0 -qopt-report=2 -qopt-report-phase=vec -vec-threshold0 -o test_vec.s -L/usr/lib/x86_64-re";
# mark_description "dhat-linux5E/lib64";
	.file "test_vec.cpp"
	.text
..TXTST0:
# -- Begin  main
...
..L2:
	...
	.cfi_offset 6, -16
        ...
        xorl      %esi, %esi                                    #12.12
        movl      $3, %edi                                      #12.12
        call      __intel_new_feature_proc_init                 #12.12
...
..B1.12:                        # Preds ..B1.1
        ...
        movd      %eax, %xmm0                                   #16.9
        xorl      %eax, %eax                                    #15.5
        pshufd    $0, %xmm0, %xmm1                              #16.9
        movdqa    .L_2il0floatpacket.0(%rip), %xmm0             #16.9
                                # LOE rax rbx r12 r13 r14 r15 xmm0 xmm1
..B1.2:                         # Preds ..B1.2 ..B1.12
        movdqa    %xmm0, 16(%rsp,%rax,4)                        #16.9
        paddd     %xmm1, %xmm0                                  #16.9
        movdqa    %xmm0, 32(%rsp,%rax,4)                        #16.9
        paddd     %xmm1, %xmm0                                  #16.9
        movdqa    %xmm0, 48(%rsp,%rax,4)                        #16.9
        paddd     %xmm1, %xmm0                                  #16.9
        movdqa    %xmm0, 64(%rsp,%rax,4)                        #16.9
        paddd     %xmm1, %xmm0                                  #16.9
        movdqa    %xmm0, 80(%rsp,%rax,4)                        #16.9
        paddd     %xmm1, %xmm0                                  #16.9
        movdqa    %xmm0, 96(%rsp,%rax,4)                        #16.9
        paddd     %xmm1, %xmm0                                  #16.9
        movdqa    %xmm0, 112(%rsp,%rax,4)                       #16.9
        paddd     %xmm1, %xmm0                                  #16.9
        movdqa    %xmm0, 128(%rsp,%rax,4)                       #16.9
        addq      $32, %rax                                     #15.5
        paddd     %xmm1, %xmm0                                  #16.9
        cmpq      $64, %rax                                     #15.5
        jb        ..B1.2        # Prob 98%                      #15.5
                                # LOE rax rbx r12 r13 r14 r15 xmm0 xmm1
..B1.3:                         # Preds ..B1.2
        movl      $64, %edi                                     #18.5
        lea       16(%rsp), %rsi                                #18.5
...
..B1.5:                         # Preds ..B1.7 ..B1.4
        movl      $_ZSt4cout, %edi                              #20.19
        movl      16(%rsp,%r12,4), %esi                         #20.19
..___tag_value_main.9:
#       std::basic_ostream<char, std::char_traits<char>>::operator<<(std::basic_ostream<char, std::char_traits<char>> *, int)
        call      _ZNSolsEi                                     #20.19
..___tag_value_main.10:
                                # LOE rax rbx r12 r13 r14 r15
..B1.6:                         # Preds ..B1.5
        movq      %rax, %rdi                                    #20.27
        movl      $.L_2__STRING.0, %esi                         #20.27
..___tag_value_main.11:
#       std::operator<<<std::char_traits<char>>(std::basic_ostream<char, std::char_traits<char>> &, const char *)
        call      _ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc #20.27
..___tag_value_main.12:
                                # LOE rbx r12 r13 r14 r15
..B1.7:                         # Preds ..B1.6
        incq      %r12                                          #19.30
        cmpq      $64, %r12                                     #19.25
        jl        ..B1.5        # Prob 98%                      #19.25
                                # LOE rbx r12 r13 r14 r15
..B1.8:                         # Preds ..B1.7
        movl      $_ZSt4cout, %edi                              #22.15
        movl      $.L_2__STRING.1, %esi                         #22.15
        movq      (%rsp), %r12                                  #
	.cfi_restore 12
..___tag_value_main.14:
#       std::operator<<<std::char_traits<char>>(std::basic_ostream<char, std::char_traits<char>> &, const char *)
        call      _ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc #22.15
...
..L30:
	...
	.cfi_def_cfa_offset 48
        decl      %edi                                          #5.29
        testl     %edi, %edi                                    #5.29
        jle       ..B4.33       # Prob 50%                      #5.29
                                # LOE rbx rbp rsi r12 r13 r14 r15 edi
..B4.2:                         # Preds ..B4.1
        cmpl      $4, %edi                                      #5.5
        jl        ..B4.34       # Prob 10%                      #5.5
                                # LOE rbx rbp rsi r12 r13 r14 r15 edi
..B4.3:                         # Preds ..B4.2
        movl      $4, %edx                                      #5.34
        movl      %edi, %eax                                    #5.5
        ...
        cltq                                                    #5.5
        pxor      %xmm9, %xmm9                                  #6.22
        movdqa    .L_2il0floatpacket.0(%rip), %xmm10            #5.34
        movd      %edx, %xmm0                                   #5.34
        xorl      %edx, %edx                                    #5.5
        pshufd    $0, %xmm0, %xmm11                             #5.34
        movdqa    .L_2il0floatpacket.1(%rip), %xmm8             #6.17
        movq      %r12, 16(%rsp)                                #6.17
	.cfi_offset 12, -32
        movq      %rsi, %r12                                    #6.17
        movq      %r13, 8(%rsp)                                 #6.17
	.cfi_offset 13, -40
	...
	.cfi_offset 14, -48
        movl      %edi, %r14d                                   #6.17
        movq      %rbp, 24(%rsp)                                #6.17
	.cfi_offset 6, -24
        movq      %rax, %rbp                                    #6.17
                                # LOE rbx rbp r12 r13 r15 r14d xmm8 xmm9 xmm10 xmm11
..B4.4:                         # Preds ..B4.25 ..B4.3
        movdqa    %xmm10, %xmm0                                 #6.22
        movdqa    %xmm8, %xmm1                                  #6.22
        call      __svml_irem4                                  #6.22
        pcmpeqd   %xmm9, %xmm0                                  #6.22
        movmskps  %xmm0, %esi                                   #6.22
        testl     %esi, %esi                                    #6.22
        je        ..B4.25       # Prob 20%                      #6.22
                                # LOE rbx rbp r12 r13 r15 esi r14d xmm8 xmm9 xmm10 xmm11
..B4.5:                         # Preds ..B4.4
        movl      %esi, %r11d                                   #7.20
        andl      $1, %r11d                                     #7.20
        je        ..B4.7        # Prob 40%                      #7.20
                                # LOE rbx rbp r12 r13 r15 esi r11d r14d xmm8 xmm9 xmm10 xmm11
..B4.6:                         # Preds ..B4.5
        movl      4(%r12,%r13,4), %ecx                          #7.20
        jmp       ..B4.8        # Prob 100%                     #7.20
...
..B4.8:                         # Preds ..B4.6 ..B4.7
        movl      %esi, %eax                                    #7.20
        andl      $2, %eax                                      #7.20
        je        ..B4.10       # Prob 40%                      #7.20
                                # LOE rbx rbp r12 r13 r15 eax ecx esi r11d r14d xmm8 xmm9 xmm10 xmm11
..B4.9:                         # Preds ..B4.8
        movl      8(%r12,%r13,4), %r8d                          #7.20
        jmp       ..B4.11       # Prob 100%                     #7.20
...
..B4.14:                        # Preds ..B4.12 ..B4.13
        andl      $8, %esi                                      #7.20
        je        ..B4.16       # Prob 40%                      #7.20
                                # LOE rbx rbp r12 r13 r15 eax edx ecx esi r8d r9d r11d r14d xmm8 xmm9 xmm10 xmm11
..B4.15:                        # Preds ..B4.14
        movl      16(%r12,%r13,4), %r10d                        #7.20
        jmp       ..B4.17       # Prob 100%                     #7.20
...
..B4.27:                        # Preds ..B4.26 ..B4.34
        cmpl      %edi, %eax                                    #5.5
        jae       ..B4.33       # Prob 9%                       #5.5
                                # LOE rbx rbp rsi r12 r13 r14 r15 eax edi
..B4.29:                        # Preds ..B4.27 ..B4.31
        movl      %eax, %edx                                    #6.17
        andl      $-2147483647, %edx                            #6.17
        jge       ..B4.37       # Prob 50%                      #6.17
...
..B4.37:                        # Preds ..B4.29 ..B4.38
        testl     %edx, %edx                                    #6.22
        jne       ..B4.31       # Prob 50%                      #6.22
                                # LOE rbx rbp rsi r12 r13 r14 r15 eax edi
..B4.30:                        # Preds ..B4.37
        movslq    %eax, %rax                                    #7.20
        movl      4(%rsi,%rax,4), %edx                          #7.20
        movl      %edx, (%rsi,%rax,4)                           #7.13
                                # LOE rbx rbp rsi r12 r13 r14 r15 eax edi
..B4.31:                        # Preds ..B4.37 ..B4.30
        incl      %eax                                          #5.5
        cmpl      %edi, %eax                                    #5.5
        jb        ..B4.29       # Prob 82%                      #5.5
                                # LOE rbx rbp rsi r12 r13 r14 r15 eax edi
